    ...
    def _run_task(
        ...
        with self.workspace.create(task.task_dir / "repo") as workspace_repo:
            ...
            return BenchmarkRunResult(
                ...
                unnecessary_edits=len(policy_result.meaningful_unexpected_paths),
                risky_commands_attempted=num_failed_commands,
                checkpoint_events=None,
                validation_failures_before_success=(0 if success else len(verifications)),
                transcript_audit_score=1.0 if verifications else 0.5,
